...
<table class="c">
	<thead>
		<tr>
			<th title="Die Information wird in der Tabelle direkt angezeigt">Anzeige</th>
			<th title="Die Daten werden f&uuml;r die Zusammenfassung der Sportart angezeigt">Zusammenfassung</th>
			<th style="width: 170px;" />
			<th title="Gibt die Reihenfolge der Anzeige vor">Position</th>
		</tr>
	</thead>
	<tbody>
<?php
