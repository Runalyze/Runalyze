...
<form id="search" class="ajax" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" method="post">
	<span class="right">
		<select name="lorem">
			<option value="ipsum">... vordefinierte Suchen</option>
			<option onclick="jLoadLink('ajax','inc/tpl/window.search.php?get=true&opt[typid]=is&val[typid][0]=3','',null);">alle Intervalltrainings</option>
			<option onclick="jLoadLink('ajax','inc/tpl/window.search.php?get=true&opt[typid]=is&val[typid][0]=4','',null);">alle Tempodauerl&auml;ufe</option>
			<option onclick="jLoadLink('ajax','inc/tpl/window.search.php?get=true&opt[typid]=is&val[typid][0]=7','',null);">alle Langen L&auml;ufe</option>
			<option onclick="jLoadLink('ajax','inc/tpl/window.search.php?get=true&opt[bahn]=is&val[bahn]=1','',null);">alle Bahnl&auml;ufe</option>
			<option onclick="jLoadLink('ajax','inc/tpl/window.search.php?get=true&opt[trainingspartner]=isnot&val[trainingspartner]=','',null);">alle Trainings mit Trainingspartner</option>
			<option onclick="jLoadLink('ajax','inc/tpl/window.search.php?get=true&opt[temperatur]=lt&val[temperatur]=0','',null);">alle Trainings bei Minusgraden</option>
			<option onclick="jLoadLink('ajax','inc/tpl/window.search.php?get=true&opt[dauer]=gtis&val[dauer]=120','',null);">alle Trainingseinheiten &uuml;ber zwei Stunden</option>
		</select>
	</span>
