...
class AdminView {
	...
	private function getSettingsFieldset() {
        ...
        $Fieldset->addField( new FormularInput('darksky_api_key', Ajax::tooltip(__('ForecastIO API-Key'), __('Loading weather from forecast.io requires an api key, see https://developer.forecast.io/'))) );
