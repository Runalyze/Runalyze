...
INSERT INTO runalyze_dataset (keyid, active, position, accountid) SELECT 42, 1, 0,a.id FROM runalyze_account a LEFT JOIN runalyze_dataset d ON a.id=d.accountid AND d.keyid!=42 GROUP BY d.accountid;DELETE FROM runalyze_conf WHERE `key` = 'DB_SHOW_DIRECT_EDIT_LINK';