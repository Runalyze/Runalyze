...
/**
 * Generated by PHPUnit_SkeletonGenerator 1.2.0 on 2014-12-07 at 15:35:49.
 */
class DistanceTest extends \PHPUnit_Framework_TestCase {
	...
	public function testAutoFormat() {
		...
		$this->assertEquals('100m', $Distance->set(0.1)->string(Distance::FORMAT_AUTO, 2));
		$this->assertEquals('1.000m', $Distance->set(1.0)->string(Distance::FORMAT_AUTO, 2));
		$this->assertEquals('1.500m', $Distance->set(1.5)->string(Distance::FORMAT_AUTO, 2));
		$this->assertEquals('1,75&nbsp;km', $Distance->set(1.75)->string(Distance::FORMAT_AUTO, 2));
		$this->assertEquals('3.000m', $Distance->set(3.0)->string(Distance::FORMAT_AUTO, 2));
		$this->assertEquals('5,00&nbsp;km', $Distance->set(5)->string(Distance::FORMAT_AUTO, 2));
	}
	...
	public function testWithoutUnit() {
		...
		$this->assertEquals('0,10', $Distance->set(0.1)->stringKilometer(2, false));
	}
