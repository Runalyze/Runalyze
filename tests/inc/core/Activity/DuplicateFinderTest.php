...
class DuplicateFinderTest extends \PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->PDO->exec('INSERT INTO `'.PREFIX.'training` (`activity_id`, `accountid`, `sportid`, `time`) VALUES (1448797800, 0, 0, 1477839906)');
		$this->PDO->exec('INSERT INTO `'.PREFIX.'training` (`activity_id`, `accountid`, `sportid`, `time`) VALUES (1450823800, 0, 0, 1477839906)');
