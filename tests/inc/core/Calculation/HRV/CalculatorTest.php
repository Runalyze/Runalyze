...
class CalculatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSimpleExample() {
		$Calculator = new Calculator(new Object(array(
			Object::DATA => array(
				500, 510, 530, 550, 560
			)
		)));
	...
	public function testCountings() {
		$Calculator = new Calculator(new Object(array(
			Object::DATA => array(500, 510, 550, 650, 610, 510, 500, 500, 400, 500)
		)));
		$Calculator->calculate();
	...
	public function testFiltering() {
		$CalculatorDefaultFilter = new Calculator(new Object(array(
			Object::DATA => array(50, 100, 150, 250, 300, 350)
		)));
		$CalculatorDefaultFilter->calculate();
		$this->assertEquals(300, $CalculatorDefaultFilter->mean());

		$CalculatorWithoutFilter = new Calculator(new Object(array(
			Object::DATA => array(50, 100, 150, 250, 300, 350)
		)), array());
		$CalculatorWithoutFilter->calculate();
		$this->assertEquals(200, $CalculatorWithoutFilter->mean());

		$CalculatorWithSpecialFilter = new Calculator(new Object(array(
			Object::DATA => array(50, 100, 150, 250, 300, 350)
		)), array(75, 175));
