...
class PaceCalculatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testNoDistanceGiven() {
		$Calculator = new PaceCalculator(new Object(array(
	...
	public function testSmoothPaceForRuntasticData() {
		$Calculator = new PaceCalculator(new Object(array(
			Object::TIME => array(0, 25, 27, 31, 32, 35, 37, 39, 45, 50),
			Object::DISTANCE => array(0.0, 0.0, 0.0, 0.052, 0.052, 0.052, 0.052, 0.052, 0.071, 0.085)
		)));
