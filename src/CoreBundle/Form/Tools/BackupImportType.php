...
class BackupImportType extends AbstractType
{
    ...
    {
        $builder
            ->add('overwrite_config', CheckboxType::class, [
                'required' => false,
                'label' => 'Overwrite general configuration'
            ])
            ->add('overwrite_dataset', CheckboxType::class, [
                'required' => false,
                'label' => 'Overwrite dataset configuration'
            ])
            ->add('overwrite_plugin', CheckboxType::class, [
                'required' => false,
                'label' => 'Overwrite plugins'
            ])
            ->add('delete_trainings', CheckboxType::class, [
                'required' => false,
                'label' => 'Delete all old activities'
            ])
            ->add('delete_user_data', CheckboxType::class, [
                'required' => false,
