...
RunalyzeLeaflet.getNewLayers = function(){
	var osmContribution = '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors';
	var layers = {
		...
		'OpenMapSurfer': L.tileLayer(
			'//korona.geog.uni-heidelberg.de/tiles/roads/x={x}&y={y}&z={z}', {
				detectRetina: true,
				attribution: '&copy; <a href="http://giscience.uni-hd.de/">GIScience Research Group University of Heidelberg</a>, ' + osmContribution
			}
		),
		'HikeBikeMap': L.tileLayer(
			'http://{s}.tiles.wmflabs.org/hikebike/{z}/{x}/{y}.png', {
				detectRetina: true,
				attribution: '&copy; <a href="http://www.opencyclemap.org">OpenCycleMap</a>, ' + osmContribution
			}
		),
		'Hydda': L.tileLayer(
			'//{s}.tile.openstreetmap.se/hydda/full/{z}/{x}/{y}.png', {
				detectRetina: true,
				attribution: '&copy; <a href="http://openstreetmap.se/">OpenStreetMap Sweden</a>, ' + osmContribution
			}
		),
		'Carto': L.tileLayer(
