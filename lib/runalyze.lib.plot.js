...
(function(){
	var RunalyzePlot = {
			...
			addAnnotationTo: function(idOfPlot, x, y, text) {
				var $e = $("#"+idOfPlot),
					o = this.getPlot(idOfPlot).pointOffset({'x':x, 'y':y}),
					l = Math.round(100*o.left/$e.outerWidth()),
					t = Math.round(100*o.top/$e.outerHeight());
				$e.append('<div class="annotation" style="left:'+l+'%;top:'+t+'%;">'+text+'</div>');
