...
function jSubmit() {
	$("form.ajax").unbind("submit").submit(function(e){
		...
		if (form_id != "training" && form_id != "search" && form_id != "newtraining" && form_id != "sportler" && form_id != "config" && form_id != "pluginconfig" && form_id != "schuhe" && form_id != "schuhe_edit") {
		...
		$("#ajax").load($(this).attr("action"), $(this).serializeArray(), function(){
			...
			if (form_id != "search" && form_id != "config" && form_id != "pluginconfig")
				jReloadContent();
