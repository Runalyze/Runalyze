	...
	var RunalyzeLog = {
			...
			init: function() {
				...
				var $container = $("#"+RunalyzeLog.options.containerId),
					...
					table = '<table class="fullWidth nomargin"><thead><tr><th style="width:100px;"></th><th>Fehlermeldungen</th><th style="width:70px;"></th><th style="width:3px;"><img onclick="RunalyzeLog.clear();" alt="Log leeren" src="img/delete_gray.gif" class="link" /></th></thead><tbody id="errorTable"></tbody></table>';
