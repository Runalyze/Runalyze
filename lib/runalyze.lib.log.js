	...
	var RunalyzeLog = {
			...
			init: function() {
				...
				var $container = $("#"+RunalyzeLog.options.containerId),
					clearLink = '<span onclick="RunalyzeLog.clear();" class="link"><i class="icon-delete"></i></span>',
			...
			iconFor: function(i) {
				return '<span onclick="RunalyzeLog.remove('+i+');" class="link"><i class="icon-delete"></i></span>';
			}
	}
