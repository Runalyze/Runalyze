 ...
 */
define('MAIL_SENDER', 'mail@laufhannes.de');
 ...
 */
define('OPENWEATHERMAP_API_KEY', 'eb3e6455118fb6879a9ae8cb30a82cba');
 ...
 */
define('NOKIA_HERE_APPID', 'tGaXC0G7JoT5tEvUJW8b');
 ...
 * @see https://developer.here.com
 */
define('NOKIA_HERE_TOKEN', 'rXyIHiKvci-xdLuLEPJepQ');

/**
 * Define the mail sending server
 * @var string
 */
define('SMTP_HOST', 'w0074e60.kasserver.com');
 ...
 * @var string
 */
define('SMTP_USERNAME', 'm019ab04');

/**
 * Define the auth password for the smtp server
 * @var string
 */
define('SMTP_PASSWORD', 'fc683f6a');
