...
class Version20161027173150 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('UPDATE `'.$prefix.'equipment_type` SET `max_km` = NULL WHERE `max_km` > \'16777215\'');
        $this->addSql('UPDATE `'.$prefix.'equipment_type` SET `max_time` = NULL WHERE `max_time` > \'16777215\'');
        ...
        $this->addSql('UPDATE `'.$prefix.'user` SET `pulse_rest` = NULL WHERE `pulse_rest` > \'255\'');
        $this->addSql('UPDATE `'.$prefix.'user` SET `pulse_max` = NULL WHERE `pulse_max` > \'255\'');
        ...
        $this->addSql('ALTER TABLE `'.$prefix.'training`
                  ...
                  MODIFY `distance` decimal(6,2) unsigned NOT NULL DEFAULT \'0.00\',
                  MODIFY `s` decimal(8,2) unsigned NOT NULL DEFAULT \'0.00\',
